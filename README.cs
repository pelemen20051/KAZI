    ...
    public partial class Form1 : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (carToDelete != null)
            {
                ...
                dataGridView1.DataSource = null; // Обновляю привязку данных
                dataGridView1.DataSource = cars;
            }
            else
            {
        ...
        private void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                // Устанавливаю лицензию EPPlus для некоммерческого использования
                ...
                using (ExcelPackage excel = new ExcelPackage())
                {
                    ...
                    // Добавляет  данные из списка автомобилей
                    ...
                    // Сохраняет файл Excel через диалог сохранения
                    SaveFileDialog saveFileDialog = new SaveFileDialog();
                    saveFileDialog.Filter = "Excel файлы (*.xlsx)|*.xlsx";
                    if (saveFileDialog.ShowDialog() == DialogResult.OK)
                    {
                        // Сохраняется Excel-файл на диске
